...
public class DataStorager extends DataManager {
    ...
    public DataStorager() {
        ...
        // mihoyo
        addImageResource("MIHOYO", new ImageData("./resource/mihoyo.png"));
        ...
        // 退回
        addImageResource("BACK_BTN", new ImageData("./resource/btn_back0.png"));
        addImageResource("BACK_PRESS_BTN", new ImageData("./resource/btn_back1.png"));
        // 跳过
        addImageResource("SKIP_BTN", new ImageData("./resource/smsBuyMustSkip.png"));
        addImageResource("SKIP_PRESS_BTN", new ImageData("./resource/smsBuyMustSkip1.png"));

        // 装饰图标
        addImageResource("DECORATE_ICON", new ImageData("./resource/zjan.png"));
        ...
        // 原神背景
        // addImageResource("YUANSHEN", new ImageData("./Resource/yuanshen.gif"));
    ...
    public static void main(String[] args) throws IOException {
        ...
        // sub image
        BufferedImage bi = getImage("YUANSHEN");
